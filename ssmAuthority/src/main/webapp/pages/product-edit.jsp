...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/product/editSave.do"
...
<%--						</div>--%>
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="departureTimeStr"
								   placeholder="出发时间" value="${product.departureTimeStr }">
						</div>
						...
						<div class="col-md-10 data rowHeight2x">
							<input class="form-control rowHeight2x "  style="height: 84px" rows="3" placeholder="其他信息"
								name="productDesc" value="${product.productDesc}"></input>
						</div>
	...
	<script>
		document.getElementById("textValue").value = ${product.productDesc}
